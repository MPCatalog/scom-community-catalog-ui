// -----------------------------------------------------------------------
// <copyright file="InstalledCatalogQuery.cs">
...
namespace Community.ManagementPackCatalog.UI.DataConnectors
{
    ...
    /// <summary>
    /// The InstalledCatalogQuery class is an extension of the Cache Query,
    /// this class ties directly to a MOM UI DataGrid and provides the data via cache or direct load.
    /// </summary>
    internal class InstalledCatalogQuery : Query<GitHubPackDetail>, ISerialization
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledCatalogQuery"/> class.
        /// </summary>
        public InstalledCatalogQuery()
        {
        ...
        public object Deserialize(byte[] bytes)
        {
            ...
            CheckAndFillInstalledPacksList();
        ...
        protected override ICollection<GitHubPackDetail> DoQuery(string criteria)
        {
            ...
            // Return only those packs in the index that have an InstalledManagementPack
        ...
        /// </summary>
        private void CheckAndFillInstalledPacksList()
        {
